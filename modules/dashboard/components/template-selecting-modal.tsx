        ...
        >
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                {step === "select" ? (
                    <>
                        <DialogHeader>
                            <DialogTitle className="text-2xl font-bold text-[#f36e06] flex items-center gap-2">
                                <Plus size={24} className="text-[#f36e06]" />
                                Select a Template
                            </DialogTitle>
                            <DialogDescription>
                                    ...
                                    {filteredTemplates.length > 0 ? (
                                        filteredTemplates.map((template) => (
                                            <div
                                                ...
                                                className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                                                    ${selectedTemplate === template.id
                                                        ? "border-[#f36e06]  shadow-[0_0_0_1px_#f36e06,0_8px_20px_rgba(243,110,6,0.15)]"
                                                        : "hover:border-[#f36e06] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                                                    }
                                                    `}
                                            ...
                                            >
                                                ...
                                                {selectedTemplate === template.id && (
                                                    <div className="absolute top-2 left-2 bg-[#f36e06] text-white rounded-full p-1">
                                                        <Check size={14} />
                                                    </div>
                                                )}
                        ...
                        <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button
                                    className="bg-[#f36e06] hover:bg-[#e65c00] text-white"
                    ...
                    <>
                        <DialogHeader >
                            <DialogTitle className="text-2xl font-bold text-[#f36e06]">
                        ...
                        <div className="flex flex-col gap-6 py-4">
                            ...
                            <div className="p-4 shadow-[0_0_0_1px_#f36e06,0_8px_20px_rgba(243,110,6,0.15)] rounded-lg border">
                                    ...
                                    {templates
                                        ...
                                        ?.features.map((feature) => (
                                            <div key={feature} className="flex items-center gap-2">
                                                <Zap size={14} className="text-[#f36e06]" />
